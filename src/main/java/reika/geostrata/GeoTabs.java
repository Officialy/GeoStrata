...
public class GeoTabs {
   ...
   /*     GEOSTRATA = event.registerCreativeModeTab(Identifier.parse(GeoStrata.MODID, "geostrata"), (builder -> {
        ...
        STONES = event.registerCreativeModeTab(Identifier.parse(GeoStrata.MODID, "stones"), (builder -> {
        ...
        STAIRS = event.registerCreativeModeTab(Identifier.parse(GeoStrata.MODID, "stairs"), (builder -> {
        ...
        SLABS = event.registerCreativeModeTab(Identifier.parse(GeoStrata.MODID, "slabs"), (builder -> {
        ...
        ORES = event.registerCreativeModeTab(Identifier.parse(GeoStrata.MODID, "ores"), (builder -> {
